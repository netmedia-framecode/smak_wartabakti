...
$pendaftaran = mysqli_query($conn, "SELECT * FROM pendaftaran WHERE status_pendaftaran='Diverifikasi' ORDER BY nama_lengkap ASC");

$mpdf = new \Mpdf\Mpdf();

$mpdf->WriteHTML('<h2 style="text-align: center;">Lolos Verifikasi Pendaftaran Peserta Didik Baru <br>SMA Katholik Wartabakti</h2>');
...
$mpdf->Output('Lolos_Verifikasi_Pendaftaran_Peserta_Didik_Baru.pdf', 'D');
exit;
