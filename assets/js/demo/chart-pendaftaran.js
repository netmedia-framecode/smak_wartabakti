...
// Area Chart Example
var ctx = document.getElementById("chart-pendaftaran");
...
var datasets = categories.map((category, index) => {
  return {
    label: category, // Menggunakan kategori (jenis_kelamin) sebagai label
...
var myBarChart = new Chart(ctx, {
  type: "bar",
  data: {
    labels: Array.from(new Set(dataGrafik.map((item) => item.month))), // Menggunakan bulan sebagai label pada sumbu x
    datasets: datasets,
  },
  options: {
